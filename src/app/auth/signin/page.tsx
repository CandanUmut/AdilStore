    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 font-bold text-lg tracking-tight text-[var(--text)] no-underline"
          >
          ...
          <h1 className="text-xl font-extrabold tracking-tight mt-4 mb-1">Sign in</h1>
          <p className="text-sm text-[var(--text-soft)]">Access your developer portal</p>
        </div>
        ...
        <p className="text-center text-xs text-[var(--text-soft)] mt-2">
          <Link href="/" className="text-[var(--text-soft)] hover:text-[var(--accent)]">
            ← Back to AdilStore
          </Link>
        </p>
      </div>
