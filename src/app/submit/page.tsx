...
export default function SubmitPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setForm({ app_name: "", app_url: "", category_id: "", description_en: "", contact_email: "", extra_notes: "" });
    setIconFile(null);
  }
      ...
      <div className="max-w-[720px] mx-auto px-4 md:px-6 py-8">
        ...
        >
          ...
          <div className="px-3 py-2 rounded-xl bg-[rgba(56,189,248,0.08)] border border-[rgba(56,189,248,0.2)] text-[11px] text-[var(--text-soft)]">
            🛡️ Your submission is reviewed manually before it goes live. We do not sell your contact email. We will only use it to follow up about your submission.
          </div>
